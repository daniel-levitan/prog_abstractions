...
*
* The use of the TokenScanner class is illustrated by the following code * pattern, which reads the tokens in the string variable input:
*
...
*          }
*
* This version of the TokenScanner class includes the ignoreWhitespace * method. The other options available in the library version of the
